...
func Test_valuesToProjects(t *testing.T) {
	got := ValuesToProjects([][]interface{}{
		{"Name", "Title", "Parts Released", "Parts Archived", "Season", "Submission Link", "Submission Deadline", "Sources", "Composers", "Arrangers", "Editors/Adaptors", "Transcribers", "Preparers", "Clix By", "Reviewers", "Lyricists", "Additional HtmlSource", "Reference Track", "Choir Pronunciation Guide", "Youtube Link", "Banner Link", "Youtube Embed", "Bandcamp Embed"},
