...
func Test_valuesToProjects(t *testing.T) {
	got := valuesToProjects([][]interface{}{
		{"Name", "Title", "Released", "Archived", "Season", "Submission Link", "Submission Deadline", "Sources", "Composers", "Arrangers", "Editors/Adaptors", "Transcribers", "Preparers", "Clix By", "Reviewers", "Lyricists", "Additional Content", "Reference Track", "Choir Pronunciation Guide", "Youtube Link", "Banner Link", "Youtube Embed", "Bandcamp Embed"},
