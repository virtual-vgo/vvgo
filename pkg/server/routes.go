...
func Routes() http.Handler {
	...
	mux.HandleApiFunc("/api/v1/guild_members/list", guild_members.HandleList, models.RoleAnonymous)
	mux.HandleApiFunc("/api/v1/auth/password", auth.Password, models.RoleAnonymous)
	mux.HandleApiFunc("/api/v1/logs", api.LogsHandler, models.RoleAnonymous)
