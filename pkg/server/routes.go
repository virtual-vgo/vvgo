...
func Routes() http.Handler {
	...
	mux.HandleApiFunc("/api/v1/mixtape", mixtape.ProjectsHandler, models.RoleVVGOMember)
	mux.HandleApiFunc("/api/v1/parts", api.Parts, models.RoleVVGOMember)
	...
	mux.HandleFunc("/mixtape/NewProjectWorkflow", views.NewProjectWorkflow, models.RoleVVGOExecutiveDirector)
