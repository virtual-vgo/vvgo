import { CreditsTeamRow, CreditsTopic, Project, latestProject, useCreditsTable, useProjects } from "../datasets";
    ...
    return (
        <div className="text-muted mb-4 fa-border">
            <h2 className="m-2">
                <em>Hey beautiful!</em> 😉{" "}
                <em>
                    This project is still in production, but we are no longer accepting submissions. Stay tuned for
                    upcoming release news in <LinkChannel channel={GuildChannel.Announcements} />.
                </em>{" "}
                😘
            </h2>
        </div>
